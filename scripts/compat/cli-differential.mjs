...
const CASES = [
    ...
    { name: 'canonicalize an uppercase id', argv: ['canonicalize', FIXED] },
    { name: 'canonicalize a lowercase id', argv: ['canonicalize', FIXED.toLowerCase()] },
    { name: 'canonicalize a mixed-case lifecycle id', argv: ['canonicalize', '4sq1nzt5hc0-4SQ1nzT5P1s'] },
    { name: 'canonicalize rejects junk', argv: ['canonicalize', 'not-a-ttid'] },
    { name: 'canonicalize without an id', argv: ['canonicalize'] },
